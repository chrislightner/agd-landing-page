...
<body>
  ...
  <main id="main">
    ...
    <div class="container coverages-two">
      ...
      <span style="font-size:0.8em;display:block;margin-top:10px;line-height: normal;"><sup>*</sup>10% group discount on every pet, plus an additional 10% multi-pet discount on all pets after the first. Group discount is not available in&nbsp;HI&nbsp;or&nbsp;TN.</span>
